...
const Header = () => {
  ...
  return (
    ...
    <div className="Header__topbar space__beetween">
      ...
      <Link to="/">
          <img
            src="https://st3.depositphotos.com/5142301/12766/v/600/depositphotos_127668190-stock-illustration-y-letter-logo-with-green.jpg"
            alt=""
            className="logo"
            style={{
              width: "150px",
      ...
      >
        ...
        >
          <mail style={{
            padding:"0px 5px"
          }}>Email:ammashealthmixpkt@gmail.com</mail> 
        </span>
      </div>
    </div>
    {/* Header Navbar */}
    <div className="navbar flex pz__10 space__beetween" ref={switcherTab}>
      ...
      <div className="rightOption flex align__items__center">
        ...
        <Link to="/favourites">
          ...
          >
            <span style={{fontFamily:"Urbanist"}}>{favouriteItems.length}</span>
          </div>
        </div>
        <div className="cart__items flex align__items__center">
          <div className="cart__items flex pointer relative">
            ...
            >
              <span style={{fontFamily:"Urbanist"}}>{cartItems.length}</span>
            </div>
          </div>
        </div>
